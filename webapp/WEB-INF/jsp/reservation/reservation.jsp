...
<body id="hanbit">
   ...
   <div class="main-content">
      ...
      <div class="select-Seat">
         <table id="seatTable" class="seat-Table">
            <thead>
               <tr>
                  <th class="screen"  colspan="9">screen</th>
               </tr>
            </thead>
         ...
         <div class="button-group">
         	<button type="button" class="btn btn-success" id="commit-btn">예매하기</button>
   ...
   <div class="common-bottom">
    <a href="#hanbit" title="To Top">
      ...
      <footer class="container-fluid bg-4 text-center">
           ...
           대표이사 배형진 | 사업자등록번호 123-45-67899 | 통신판매업신고번호 제1557호
      </footer>
