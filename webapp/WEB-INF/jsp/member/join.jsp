...
<div class="common-top-container">
	...
	<div class="main-content">
		<div class="main-content-body login-form">
				...
				<div class="form-group has-success has-feedback">
					<lable class="member" for="username">이름</lable>
					<input type="text" class="form-control" placeholder="이름" id="name" maxlength="10" size="10">
				</div>
				<div class="form-group has-success has-feedback">
				...
				<div class="form-group has-success has-feedback">
					<lable class="member" for="pwcheck">비밀번호확인</lable>
					<input type="password" class="form-control" placeholder="비밀번호확인" id="pwcheck" maxlength="20" size="10">
				</div>

				<div class="container">
					  <div class="container-btn">
					    <button class="btnlogin btn btn-success">가입</button>
