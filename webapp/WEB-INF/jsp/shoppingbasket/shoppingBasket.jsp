...
<link rel="stylesheet" href="/static/css/shoppingBasket.css"/>
</head>
<body id="hanbit">
   ...
   <div class="shoppingBasket-content">

      <div class="shoppingBasket-list">장바구니
		...
		<div class="btnOption">
         <span class="btnPayment">전체결제하기</span>
         <span class="allDelete">전체삭제하기</span>
      	</div>
...
<script src="/static/js/shoppingBasket.js"></script>
